 ...
 * Java classes
*/
public class LatinCodeGenerator implements MorphCodeGenerator {

    private static Logger logger = Logger.getLogger(LatinCodeGenerator.class);
