<div id="side_col">
    ...
    <ul>
        ...
        <li>Homer, <span class="title">Odyssey</span> (<a href="/hopper/text?doc=Perseus:text:1999.01.0136">English</a>, <a href="/hopper/text?doc=Perseus:text:1999.01.0135">Greek</a>)</li>
    ...
    <a href="/hopper/artifact?name=BCMA+1914.6.6&object=Coin">
        <img class="thumb_img" src="http://images.perseus.tufts.edu/images/thumbs/1989.00.1/1989.00.0214">
    </a>
    <div class="caption">
    ...
    onclick="javascript: pageTracker._trackPageview('/outgoing/CHS');">Center for Hellenic Studies</a></li>
        <li><a target="_blank" href="http://arachne.uni-koeln.de/"
