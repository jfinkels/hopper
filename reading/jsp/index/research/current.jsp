...
<div id="main">
    ...
    <jsp:param name="subtabActive" value="current"/>
    </jsp:include> 	
...
<ul>
    ...
    is now completely different. We can now provide our students with opportunities to begin 
    ...
    <ul>
        ...
        as the Loeb Classical Library and Bud&eacute; Editions, providing a range of background and 
        ...
        supervised students with various levels of Greek and Latin. Projects such as the 
        <a target="_blank"
        ...
        research. We have studied Greek and Latin for millennia but Treebanks (see below) allow us to place 
    ...
    particular and the world that it helped create in general. Our ultimate goal is to prepare for 
    ...
    primary sources in Perseus provide one example) began to add semantic markup (e.g., representing that 
    ...
    images but also other forms of annotation (e.g., morphological and syntactic analysis, indices of 
    ...
    (especially commentaries, indices, specialized lexica), with targeted creation of TEI-compliant XML 
    ...
    text from intentional editorial variations. The immediate goal is to create a searchable collection 
    ...
    quoting source. The comprehensive collection of Greek and Latin source texts, with scanned page images 
    ...
    contain a large body of information that could, if converted into a machine actionable format, 
    ...
    <ul>
        ...
        or dictionary entry may contain propositional statements that automated systems could use but that 
        ...
        work. These range from basic categories such as co-reference (e.g., determining whether <em>hic</em>, 
    ...
    <em>dicit</em> ("s/he speaks, says") and has the modifier ZZZ. Such annotations organize the words 
    ...
    than 50,000 words. At the same time, we began work on what will be a 1,000,000 word Treebank for 
    classical Greek.
    </p>
    </li>
    <li>
    ...
    chapter 86), then we can identify words and phrases in the English translation that correspond to 
    ...
    human beings make hundreds or thousands of times a day but do not have time to record (e.g., when 
    ...
    readers ask about four words from a particular passage, we can predict two thirds of the other 
    ...
    being developed as a distributed collection and a method whereby humanists from around the world 
    ...
    therefore to move as many Perseus objects as possible into the Tufts Digital Library, with a 
    ...
    repository system, <a target="_blank"
    ...
    architecture where we apply programs stored on local servers to locally stored texts and other 
...
<li><a href="#collections">Focused collections on selected Greek and Latin authors</a></li>
