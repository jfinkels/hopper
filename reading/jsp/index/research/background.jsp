...
as Yahoo and Google and whose full functionality still exceeds any system with which we are familiar, 
...
new services from very large collections with hundreds of thousands and millions of books, 
...
information about people, places, organizations and other topics in a modern format), and 
...
onclick="javascript: pageTracker._trackPageview('/outgoing/TDL19thC');">
