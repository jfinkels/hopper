...
public final class search_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/includes/nesearch.html");
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<div class=\"search_widget primary\" id=\"places\">\n<div class=\"header\">\n<a class=\"toggle\" href=\"javascript:toggle('places')\" id=\"places-link\">show</a>\nSearch places\n</div>\n<div class=\"contents\" id=\"places-contents\" style=\"display:none\">\n<form action=\"nebrowser\" method=\"GET\" onsubmit=\"return validate_form(this,keyword);\">\n    <table>\n\t<tr>\n\t    <td>Search for places:</td>\n\t    <td><input name=\"keyword\" size=\"20\" /></td>\n\t    <td>\n\t\t<select name=\"placetype\">\n\t\t    <option value=\"siteName\" default=\"yes\">matching this name</option>\n\t\t    <option value=\"state\">within this state</option>\n\t\t    <option value=\"nation\">within this country</option>\n\t\t</select>\n\t    </td>\n\t    <td><input type=\"submit\" value=\"Browse\" /></td>\n\t</tr>\n    </table>\n    <input type=\"hidden\" name=\"type\" value=\"place\" />\n    <p class=\"description\">Enter the name of a place, like \"Springfield\" or\n    \"Athens\", to find all locations matching the name, or enter a state\n    (\"Illinois\") or country (\"Canada\") to find all places within that state or\n    nation. You may also enter more than one of these to narrow your search\n");
      out.write("    (\"Athens, Greece\" or \"Springfield, Illinois, United States\").</p>\n\n    <p class=\"description\">Note that abbreviations (\"USA\", \"Ill.\") do\n    <em>not</em> work at present--please stick to full names!</p>\n</form>\n</div>\n</div>\n<br>\n<div class=\"search_widget primary\" id=\"people\">\n<div class=\"header\">\n<a class=\"toggle\" href=\"javascript:toggle('people')\" id=\"people-link\">show</a>\nSearch people\n</div>\n<div class=\"contents\" id=\"people-contents\" style=\"display:none\">\n<form action=\"nebrowser\" method=\"GET\" onsubmit=\"return validate_form(this,keyword);\">\n    <table>\n\t<tr>\n\t    <td>Search for a person:</td>\n\t    <td><input name=\"keyword\" size=\"30\" /></td>\n\t    <td><input type=\"submit\" value=\"Browse\" /></td>\n\t</tr>\n\t<tr>\n\t    <td style=\"text-align: right;\">In:</td>\n\t    <td colspan=\"2\">\n\t\t<input type=\"checkbox\" name=\"first\">Forenames</input>\n\t\t<input type=\"checkbox\" name=\"last\">Surnames</input>\n\t\t<input type=\"checkbox\" name=\"full\" checked=\"checked\">Full name</input>\n\t    </td>\n\t</tr>\n    </table>\n    <p class=\"description\">Searching for \"Washington\" in \"Forenames\" and\n");
      out.write("    \"Surnames\" will return all people with Washington as a first or last name,\n    respectively. A full-name search will find anyone who matches the entire\n    search string (\"Washington Irving\").</p>\n    <input type=\"hidden\" name=\"type\" value=\"person\" />\n</form>\n</div>\n</div>\n<br>\n<div class=\"search_widget primary\" id=\"dates\">\n<div class=\"header\">\n<a class=\"toggle\" href=\"javascript:toggle('dates')\" id=\"dates-link\">show</a>\nSearch dates\n</div>\n<div class=\"contents\" id=\"dates-contents\" style=\"display:none\">\n<form action=\"nebrowser\" method=\"GET\">\n    <table>\n\t<tr style=\"text-align: right;\">\n\t\t<td>From:</td>\n\t    <td>\n\t\t<select name=\"month\">\n\t\t    <option value=\"\">[any]</option>\n\t\t    <option value=\"1\">January</option>\n\t\t    <option value=\"2\">February</option>\n\t\t    <option value=\"3\">March</option>\n\t\t    <option value=\"4\">April</option>\n\t\t    <option value=\"5\">May</option>\n\t\t    <option value=\"6\">June</option>\n\t\t    <option value=\"7\">July</option>\n\t\t    <option value=\"8\">August</option>\n\t\t    <option value=\"9\">September</option>\n");
  ...
  private boolean _jspx_meth_c_005fset_005f0(PageContext _jspx_page_context)
    ...
    // /search.jsp(2,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f0.setVar("noresults");
    // /search.jsp(2,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f0.setValue(new String("${model.noresults}"));
  ...
  private boolean _jspx_meth_c_005fset_005f1(PageContext _jspx_page_context)
    ...
    // /search.jsp(3,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f1.setVar("metadata");
    // /search.jsp(3,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f1.setValue(new String("${model.metadata}"));
  ...
  private boolean _jspx_meth_c_005fset_005f2(PageContext _jspx_page_context)
    ...
    // /search.jsp(4,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f2.setVar("corpusList");
    // /search.jsp(4,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f2.setValue(new String("${model.corpusList}"));
  ...
  private boolean _jspx_meth_c_005fset_005f3(PageContext _jspx_page_context)
    ...
    // /search.jsp(5,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f3.setVar("searchLangs");
    // /search.jsp(5,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f3.setValue(new String("${model.searchLangs}"));
  ...
  private boolean _jspx_meth_c_005fset_005f4(PageContext _jspx_page_context)
    ...
    // /search.jsp(6,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f4.setVar("defLookupLangs");
    // /search.jsp(6,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f4.setValue(new String("${model.defLookupLangs}"));
  ...
  private boolean _jspx_meth_c_005fset_005f5(PageContext _jspx_page_context)
    ...
    // /search.jsp(7,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f5.setVar("resolveFormLangs");
    // /search.jsp(7,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f5.setValue(new String("${model.resolveFormLangs}"));
  ...
  private boolean _jspx_meth_c_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /search.jsp(47,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        if (_jspx_meth_c_005fif_005f2(_jspx_th_c_005fif_005f0, _jspx_page_context))
          return true;
        out.write("\n\t    </p>\n\t\t<input class=\"search_doc\" type=\"hidden\" name=\"doc\" value=\"");
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /search.jsp(49,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /search.jsp(49,48) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f0.setValue(new String("${metadata.creator}"));
    // /search.jsp(49,48) name = escapeXml type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /search.jsp(50,8) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f1.setValue(new String("${metadata.title}"));
    // /search.jsp(50,8) name = escapeXml type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /search.jsp(51,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f2, PageContext _jspx_page_context)
    ...
    // /search.jsp(51,50) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f2.setValue(new String("${metadata.language}"));
  ...
  private boolean _jspx_meth_c_005fout_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /search.jsp(53,60) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f3.setValue(new String("${metadata.documentID}"));
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /search.jsp(58,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("lang");
    // /search.jsp(58,1) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new String("${searchLangs}"));
  ...
  private boolean _jspx_meth_c_005fout_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /search.jsp(59,16) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f4.setValue(new String("${lang.code}"));
  ...
  private boolean _jspx_meth_c_005fif_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /search.jsp(60,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /search.jsp(61,2) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f5.setValue(new String("${lang.name}"));
  ...
  private boolean _jspx_meth_c_005fif_005f4(PageContext _jspx_page_context)
    ...
    // /search.jsp(66,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f4, PageContext _jspx_page_context)
    ...
    // /search.jsp(68,3) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setVar("corpus");
    // /search.jsp(68,3) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setItems(new String("${corpusList}"));
      ...
      if (_jspx_eval_c_005fforEach_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          if (_jspx_meth_c_005fout_005f6(_jspx_th_c_005fforEach_005f1, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f1))
            return true;
          out.write("\" name=\"collections\" checked/>");
  ...
  private boolean _jspx_meth_c_005fout_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /search.jsp(69,33) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f6.setValue(new String("${corpus.ID}"));
  ...
  private boolean _jspx_meth_c_005fout_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /search.jsp(69,92) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f7.setValue(new String("${corpus.metadata.title}"));
  ...
  private boolean _jspx_meth_c_005fif_005f5(PageContext _jspx_page_context)
    ...
    // /search.jsp(101,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f2(PageContext _jspx_page_context)
    ...
    // /search.jsp(126,3) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f2.setVar("lang");
    // /search.jsp(126,3) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f2.setItems(new String("${defLookupLangs}"));
  ...
  private boolean _jspx_meth_c_005fout_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f2)
    ...
    // /search.jsp(127,19) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f8.setValue(new String("${lang.code}"));
  ...
  private boolean _jspx_meth_c_005fout_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f2)
    ...
    // /search.jsp(127,50) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f9.setValue(new String("${lang.name}"));
  ...
  private boolean _jspx_meth_c_005fforEach_005f3(PageContext _jspx_page_context)
    ...
    // /search.jsp(155,7) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f3.setVar("lang");
    // /search.jsp(155,7) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f3.setItems(new String("${resolveFormLangs}"));
  ...
  private boolean _jspx_meth_c_005fout_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f3, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f3)
    ...
    // /search.jsp(156,19) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f10.setValue(new String("${lang.code}"));
  ...
  private boolean _jspx_meth_c_005fout_005f11(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f3, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f3)
    ...
    // /search.jsp(156,50) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f11.setValue(new String("${lang.name}"));
  ...
  private boolean _jspx_meth_c_005fforEach_005f4(PageContext _jspx_page_context)
    ...
    // /search.jsp(202,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f4.setVar("lang");
    // /search.jsp(202,5) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f4.setItems(new String("${defLookupLangs}"));
  ...
  private boolean _jspx_meth_c_005fout_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f4, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f4)
    ...
    // /search.jsp(203,19) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f12.setValue(new String("${lang.code}"));
  ...
  private boolean _jspx_meth_c_005fout_005f13(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f4, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f4)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    // /search.jsp(203,50) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f13.setValue(new String("${lang.name}"));
