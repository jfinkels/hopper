<html>
  ...
  <body onload="checkRedirect();">
    ...
    <jsp:param name="subtabActive" value="copyright"/>
      </jsp:include>
    ...
    <div id="index_main_col">
      ...
      <p><a id="anchor" name="down"></a><b>Downloads</b><br>Perseus offers several open source downloads of this site and its components:
      ...
      <p><a id="anchor" name="cite"></a><b>Citing this Web site in a bibliography<br>
        </b>
      ...
      <p>Inquiries about obtaining rights to reuse images should be directed to the relevant museums:
      ...
      <p><a id="anchor" name="fair"></a><b>Fair Use</b><br>
        For more information, see the Library of Congress documents on 
