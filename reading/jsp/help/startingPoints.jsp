<html>
  ...
  <body onload="checkRedirect();">
    ...
    <jsp:param name="subtabActive" value="startpoints"/>
      </jsp:include>
    ...
    <div id="index_main_col">
      ...
      <p>
        ...
        <img height="30" src="/img/site.gif" align="center" border="0"> <b>The Site of Delphi</b></a><br>
         ...
         <img height="30" src="/img/aphaia.gif" align="center" border="0"> <b>Fortification Architecture</b></a><br>
              <br> The ancient Greeks protected their cities from invaders with massive fortification 
      ...
      information about using Perseus.  The <a href="/hopper/help/faq">Frequently Asked Questions
